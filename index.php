              ...
              <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12" id = "heading">
                        <div class="hero-caption">
                           <span class="subheading" style = "font-size:30px">HELLO! I AM</span>
                           <h1 style = "font-size: 35px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif; color:black;
                            ">PIZ TECH !</h1>
                           <div style = "font-size:27px">I <span class="txt-rotate" data-period="2000" data-rotate='[ "Build Responsive Website.", "Build Desktop Application.", "Design Website.", "Deliver Your Project On Time."]'></span></div><hr>
                           <p style = "font-style: italic">I specialize in creating custom websites tailored to meet your unique needs. My focus is on delivering high-quality, functional, and user-friendly websites that help you stand out online.</p> 
                    ...
                    <div class="col-lg-6 col-md-6 d-none d-lg-block">
                        <div class="hero-img"> <img src="assets/img/about-area/about-us1.jpg" alt="Hero image" width = "400px" style = "border-radius:250px;border: 10px solid #90acd1;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="hero-shape custom-animation"> 
                <img src="assets/img/welcome-area/hero-shape.png" alt="animation shape">
                <img src="assets/img/welcome-area/hero-shape.png" alt="animation shape">
            </div> 
        </section> 
            ...
            <div class="container" >
                <div class="row align-items-center">
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="img-about">
                            <img class="img-fluid" src="assets/img/about-area/about-us.jpg" alt="abou me" style  = "height:500px">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-details">
                            ...
                            <p>At Piz Tech, we believe that every project is unique, and so is every solution. Our mission is to create websites that not only meet the technical requirements of our clients but also reflect their core values and vision. We specialize in building custom websites from scratch, ensuring a seamless blend of aesthetics, functionality, and user experience. Whether it’s an e-commerce platform, blog, corporate site, or portfolio, we design and develop with a keen understanding of each client’s specific needs. Our team of two professionals collaborates closely with you at every stage, transforming your ideas into digital realities. From startups to established businesses, we are committed to delivering top-tier results that drive impact and growth. With an unwavering commitment to quality and innovation, we approach every project with meticulous attention to detail, creating websites that are not only functional but also engaging, modern, and user-friendly.</p>
                        ...
                        <div id="page-1" class="page one">
                            ...
                            <div class="resume-wrap transition d-flex">
                                ...
                                <div class="text pl-3">
                                    ...
                                    <h4>Website Developer</h4>
                                    <span class="position">Volunteer at Redemers University</span>
                            ...
                            <div class="resume-wrap transition d-flex">
                                ...
                                <div class="text pl-3">
                                    <span class="date">2023</span>
                                    <h4>Website Developer</h4>
                                    <span class="position">Volunteer at Arise-Thrift</span>
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="contact-left">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body">
                            ...
                            <span><a href="mailto:toyinafepeace@gmail.com">toyinafepeace@gmail.com</a></span>
                        </div>
            ...
            <div class="col-lg-7 offset-lg-2 col-md-8">
                                <form class="row contact-form" id = "sendmessage" name = "sendmessage">
